...
//        }
        ...
        System.out.println(tileTray1.displayTileTray());
//        for(int x = 0; x < tilePool.tilePool.size(); x++){
//            LetterTile letterTile = tilePool.tilePool.get(x);
//            System.out.println(letterTile.toString());
//        }
        ...
        for(int x = 0; x < 4; x++){
            ...
            if(tileTray1.getTileFromLetter(playLetter, tileTray1.tileTray) != null){
                LetterTile n = tileTray1.getTileFromLetter(playLetter, tileTray1.tileTray);
                System.out.println("Playing tile " + n.toString());
                System.out.println("What row?");
                int row = scanner.nextInt();
                System.out.println("What column?");
                int col = scanner.nextInt();
                playedTiles.add(n);
                //playedTiles.add(tileTray1.tileTray.get(j));
            }
            else {
...
//            playedTiles.add(n);
            ...
            //if(tileTray1.checkTileExists(playLetter)){
                //int j = tileTray1.tileTray.indexOf(playLetter);
...
//            }
        ...
        for(int i = 0; i < playedTiles.size(); i++){
            move.placeTiles(tileTray1, board, playedTiles);
        }
